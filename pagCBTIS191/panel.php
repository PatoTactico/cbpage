...
<header> 
    ...
    <div class="container-content">
      ...
      <article>
          ...
          <center>
            <br><br><br><a href="panel_promedios.php"><button class="btn-primary">PANEL PROMEDIOS</button></a>
          </center>

          <center>
            <br><br><br><a href="panel_cuentas.php"><button class="btn-primary">PANEL PROFESORES</button></a>
          </center>

          <center>
            <br><br><br><a href="panel_alumnos.php"><button class="btn-primary">PANEL ALUMNOS</button></a>
          </center>
